...
export async function GET(request: NextRequest) {
  try {
    ...
    console.log('[API /products/statistics] Backend response status:', response.status);
    ...
    console.log('[API /products/statistics] Statistics fetched successfully');
    return NextResponse.json(data, { status: response.status });
  } catch (error: any) {
    console.error('[API /products/statistics] Error:', error);
