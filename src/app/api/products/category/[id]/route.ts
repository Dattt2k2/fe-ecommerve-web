...
// DELETE /api/products/category/[id] - Delete a category
export async function DELETE(
  ...
  try {
    ...
    console.log('[API /products/category/[id]] Backend response status:', response.status);
    ...
    console.log('[API /products/category/[id]] Category deleted successfully');
    return NextResponse.json(data, { status: response.status });
  } catch (error: any) {
    console.error('[API /products/category/[id]] Error:', error);
